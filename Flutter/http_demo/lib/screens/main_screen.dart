...
class MainScreenState extends State {
  ...
  List<Widget> getCategoryWdigets() {
    for (int i = 0; i < categories.length; i++) {
      categoryWidgets.add(getCategoryWdiget(categories[i]));
    }
    return categoryWidgets;
  }

  Widget getCategoryWdiget(Category category) {
    return FlatButton(
        color: Colors.black,
        child:
            Text(category.categoryName, style: TextStyle(color: Colors.white)),
